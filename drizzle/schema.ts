...
export const users = pgTable("users", {
  ...
  updatedAt: timestamp("updatedAt", { mode: "date", withTimezone: true }).defaultNow().$onUpdateFn(() => new Date()).notNull(),
...
export const batteries = pgTable("batteries", {
  ...
  lastServiceDate: timestamp("lastServiceDate", { mode: "date", withTimezone: true }),
...
export const sohPredictions = pgTable("soh_predictions", {
  ...
  predictedAt: timestamp("predictedAt", { mode: "date", withTimezone: true }).defaultNow().notNull(),
});
...
export const marketplaceListings = pgTable("marketplace_listings", {
  ...
  transactionDate: timestamp("transactionDate", { mode: "date", withTimezone: true }),
...
export const logistics = pgTable("logistics", {
  ...
  requestedAt: timestamp("requestedAt", { mode: "date", withTimezone: true }).defaultNow().notNull(),
  dispatchedAt: timestamp("dispatchedAt", { mode: "date", withTimezone: true }),
  estimatedDelivery: timestamp("estimatedDelivery", { mode: "date", withTimezone: true }),
...
export const serviceHistory = pgTable("service_history", {
  ...
  servicedAt: timestamp("servicedAt", { mode: "date", withTimezone: true }).defaultNow().notNull(),
  nextServiceDue: timestamp("nextServiceDue", { mode: "date", withTimezone: true }),
});
...
export const regulatoryProfiles = pgTable("regulatory_profiles", {
  ...
  lastGovSyncAt: timestamp("lastGovSyncAt", { mode: "date", withTimezone: true }),
...
export const carbonFootprintDeclarations = pgTable("carbon_footprint_declarations", {
  ...
  declaredAt: timestamp("declaredAt", { mode: "date", withTimezone: true }).defaultNow().notNull(),
  createdAt: timestamp("createdAt", { mode: "date", withTimezone: true }).defaultNow().notNull(),
});
...
export const warrantyRecords = pgTable("warranty_records", {
  ...
  /** Key dates */
  purchaseDate: timestamp("purchaseDate", { mode: "date", withTimezone: true }).notNull(),
  warrantyStartDate: timestamp("warrantyStartDate", { mode: "date", withTimezone: true }).notNull(),
  warrantyEndDate: timestamp("warrantyEndDate", { mode: "date", withTimezone: true }).notNull(),
  ...
  lastClaimDate: timestamp("lastClaimDate", { mode: "date", withTimezone: true }),
  /** Notes and metadata */
  notes: text("notes"),
  metadata: json("metadata"),
  /** Registration tracking */
  registeredById: integer("registeredById").notNull(),
  activatedAt: timestamp("activatedAt", { mode: "date", withTimezone: true }),
  voidedAt: timestamp("voidedAt", { mode: "date", withTimezone: true }),
...
export const warrantyClaims = pgTable("warranty_claims", {
  ...
  resolutionDate: timestamp("resolutionDate", { mode: "date", withTimezone: true }),
  /** Tracking */
...
export const webhooks = pgTable("webhooks", {
  ...
  lastDeliveryAt: timestamp("lastDeliveryAt", { mode: "date", withTimezone: true }),
  lastFailureAt: timestamp("lastFailureAt", { mode: "date", withTimezone: true }),
...
export const iotDevices = pgTable("iot_devices", {
  ...
  lastSeen: timestamp("lastSeen", { mode: "date", withTimezone: true }),
...
export const modelVersions = pgTable("model_versions", {
  ...
  trainedAt: timestamp("trained_at", { mode: "date", withTimezone: true }).defaultNow().notNull(),
  createdAt: timestamp("createdAt", { mode: "date", withTimezone: true }).defaultNow().notNull(),
});
...
export const blockchainAnchors = pgTable("blockchain_anchors", {
  ...
  anchoredAt: timestamp("anchored_at", { mode: "date", withTimezone: true }).defaultNow().notNull(),
  createdAt: timestamp("createdAt", { mode: "date", withTimezone: true }).defaultNow().notNull(),
});
