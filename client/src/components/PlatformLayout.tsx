  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 relative z-10 overflow-hidden">
        {/* Topbar — always at top of the right column, never scrolls away.
             Note: sticky requires no overflow:hidden ancestor. Since the parent
             already clips via h-screen, we use flex-shrink-0 so the header
             stays pinned while <main> below scrolls with overflow-y-auto. */}
        <header
